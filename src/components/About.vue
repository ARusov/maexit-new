    ...
    <div class="hero-body">
      <div class="container">
        ...
        <div class="container">
          ...
          <p>Profiness Business Agentur UG (haftungsbeschränkt)<br/> Magirus-Deutz-Str. 12<br/> 89077 Ulm</p>
          <h3>Kontakt:</h3>
          <p>E-Mail: info@maexit.net</p>
          <h3>Streitschlichtung</h3>
          <p>Die Europ&auml;ische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit: <a
            href="http://ec.europa.eu/consumers/odr">http://ec.europa.eu/consumers/odr</a><br/> Unsere E-MailAdresse
          ...
          <p> Quelle: <a href="https://www.e-recht24.de/impressum-generator.html">https://www.erecht24.de/</a></p>
        </div>
      </div>
    </div>
  </div>
